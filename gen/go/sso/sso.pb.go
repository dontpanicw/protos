...
package dontpanicw_sso_v1_grpcAuthv1
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x1eZ\x1cdontpanicw.sso.v1.grpcAuthv1b\x06proto3"
